...
var MarkerInfo = (_dec = (0, _index3.connect)(function (_ref) {
  ...
  function MarkerInfo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = MarkerInfo.__proto__ || Object.getPrototypeOf(MarkerInfo)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["showMarkerInfo", "Arrow", "markerInfo"], _this.handleToDetail = function () {
      var markerInfo = _this.props.map.markerInfo;
  ...
  _createClass(MarkerInfo, [{
    ...
    value: function _createData() {
      ...
      var _props$map = this.__props.map,
